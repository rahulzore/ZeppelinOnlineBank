...
<link rel="stylesheet"
	...
	<div class="container">
	<br>
	<h3>Primary Account Balance: <br> $ ${primaryAccount.accountBalance}</h3>
	...
	<thead class="thead-light">
		...
		<c:if test="${not empty primaryTransactionList}">
			<c:forEach items="${primaryTransactionList}" var="list">
		<tr>
			<td>${list.date}</td>
