	...
	<table class="table">
		...
		<c:forEach items="${userAccountList}" var="list">
			<tr>
				...
				<td>${list.email}</td>
				<!-- <td></td> -->
				<td><a href="${pageContext.request.contextPath}/employee/emp-primarytransactionlist?primaryAccountUser=${list.userName}&accountType=Primary">$ ${list.primaryAccount.accountBalance}</a></td>
