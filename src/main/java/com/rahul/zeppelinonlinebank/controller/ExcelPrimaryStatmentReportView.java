...
public class ExcelPrimaryStatmentReportView extends AbstractXlsView{

	@Override
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		
		response.setHeader("Content-disposition", "attachment; filename=\"PrimaryStatement.xls\"");
		@SuppressWarnings("unchecked")
		List<PrimaryTransaction> transactionList = (List<PrimaryTransaction>) model.get("transactionList");
		...
		int rowNum = 1;
		for(PrimaryTransaction t : transactionList) {
